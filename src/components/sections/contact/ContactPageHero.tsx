...
export function ContactPageHero() {
  ...
  return (
    <div className="shrink-0 text-center lg:text-left">
      <span className="mb-1 inline-flex items-center justify-center gap-2 font-montserrat text-[0.68rem] font-extrabold uppercase tracking-[0.22em] text-gold before:h-0.5 before:w-5 before:bg-gold before:content-[''] max-md:mb-1.5 max-md:font-outfit max-md:text-[0.62rem] max-md:font-bold max-md:tracking-[0.14em] lg:justify-start">
        {label}
      </span>
