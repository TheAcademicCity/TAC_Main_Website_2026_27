...
const mobileBadgeStyles: Record<ValueAccent, string> = {
  t1: "bg-[#e7f5ee]",
  t2: "bg-[#fdece0]",
  t3: "bg-[#f1e6f8]",
  t4: "bg-[#e8f0ed]",
    ...
    >
      ...
      <div className="hidden md:block">
        <RevealOnScroll className="mx-auto max-w-none text-center">
          ...
          <h2 className="font-montserrat text-[clamp(1.7rem,3vw,2.4rem)] font-extrabold leading-tight text-forest-deep">
            {values.title}
          </h2>
