...
export function AcademicsHeroSection() {
  ...
  return (
    <section className="relative flex min-h-[clamp(320px,48svh,480px)] items-end overflow-hidden bg-forest-deep pt-[var(--site-nav-stack)] md:min-h-[clamp(360px,50vh,480px)]">
      ...
      <Container className="relative z-[2] py-[clamp(1.5rem,4vw,3.5rem)]">
        ...
        <h1 className="max-w-[16ch] font-montserrat text-[clamp(1.75rem,7vw,3.2rem)] font-black leading-[1.06] text-white md:text-[clamp(2rem,4.5vw,3.2rem)]">
        ...
        <dl className="mt-5 grid grid-cols-2 gap-x-5 gap-y-4 sm:mt-6 sm:flex sm:flex-wrap sm:gap-8">
          {hero.stats.map((stat) => (
