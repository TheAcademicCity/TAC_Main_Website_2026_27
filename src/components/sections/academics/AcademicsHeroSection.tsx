  ...
  return (
    <section className="relative flex min-h-[330px] items-end overflow-hidden bg-forest-deep pt-[var(--site-nav-stack)] md:min-h-[clamp(360px,50vh,480px)]">
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-[rgba(14,57,52,0.3)] to-[rgba(9,38,35,0.92)] md:bg-gradient-to-t md:from-[rgba(5,22,18,0.96)] md:via-[rgba(5,22,18,0.65)] md:to-[rgba(5,22,18,0.22)]" />
      </div>
      ...
      <Container className="relative z-[2] px-5 py-6 md:py-[clamp(1.5rem,4vw,3.5rem)]">
        ...
        >
          ...
          <span className="text-emerald md:text-white/70">Academics</span>
        </nav>
