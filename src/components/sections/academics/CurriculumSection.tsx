...
const mobileTeachCards = [
  ...academicsPageContent.curriculum.approach,
  {
    number: "05",
    icon: "🌙",
    title: "Nightly Supervised Study",
    description:
      "Structured evening study with teachers on hand — a boarding advantage.",
  },
  {
    number: "06",
    icon: "🏆",
    title: "Enrichment for High Achievers",
    description: "Advanced challenges, Olympiad prep and project-based learning.",
  },
] as const;

export function CurriculumSection() {
  const { curriculum, progressionBand } = academicsPageContent;
      ...
      <div className="md:hidden">
        <RevealOnScroll>
          ...
          <h2 className="font-montserrat text-[1.25rem] font-extrabold leading-[1.28] tracking-[-0.01em] text-navy">
            How We Teach — Built for Understanding, Not Just Marks
          </h2>
        ...
        <RevealOnScroll>
          <div className="rounded-2xl bg-[linear-gradient(150deg,var(--color-navy),var(--color-charcoal))] px-[18px] py-[18px] text-center text-white">
            <h5 className="font-montserrat text-[0.875rem] font-bold">{progressionBand.title}</h5>
            <p className="mt-1.5 mb-3.5 text-[0.71875rem] leading-[1.5] text-mist">
      ...
      <div className="hidden md:block">
        <div className="grid items-center gap-7 lg:grid-cols-2 lg:gap-16">
          ...
          <RevealOnScroll delay={1} className="order-1 lg:order-2">
            ...
            <h2 className="whitespace-pre-line font-montserrat text-[clamp(1.4rem,2.4vw,1.9rem)] font-extrabold leading-tight text-forest-deep">
              {curriculum.title}
            </h2>
