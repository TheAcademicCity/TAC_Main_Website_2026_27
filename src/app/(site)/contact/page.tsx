...
export default function ContactPage() {
  return (
    <main
      id="top"
      tabIndex={-1}
      className="contact-page relative box-border min-h-[100svh] overflow-x-hidden bg-forest-deep pt-[var(--site-nav-stack)] outline-none"
    >
      <div
        aria-hidden
      ...
      <Container className="relative z-[1] flex min-h-[calc(100svh-var(--site-nav-stack))] max-w-[1200px] flex-col px-4 pt-3 pb-5 sm:px-[4vw] sm:pb-6 lg:pt-3 lg:pb-8">
        <ContactPageHero />

        <div className="mt-3 grid min-h-0 flex-1 gap-4 sm:gap-5 lg:mt-3 lg:grid-cols-2 lg:items-stretch lg:gap-6">
          <ContactFormSection />
          <ContactDetailsPanel />
        </div>
      </Container>
