...
export const achievementsGalleryContent = {
  ...
  items: [
    ...
    { label: "Main Building", category: "NEET" },
    { label: "Running Track", category: "SPORTS" },
    { label: "Swimming Pool", category: "NEET" },
    { label: "Hostel Block", category: "JEE" },
    { label: "Smart Classroom", category: "NEET" },
    { kind: "words", lines: ["Proud", "Moments."] },
    { label: "Farm & Goshala", category: "COMMERCE" },
    { label: "Dining Hall", category: "NEET" },
    { label: "Campus Pathways", category: "JEE" },
    { label: "Science Lab", category: "NEET" },
    { label: "Library", category: "COMMERCE" },
    { label: "Green Courtyard", category: "NEET" },
    { kind: "words", lines: ["Milestone."] },
    { label: "Admin Block", category: "JEE" },
    { label: "Career Guidance Session", category: "NEET" },
    { label: "Evening Campus", category: "DESIGN" },
    { label: "Investiture Ceremony", category: "JEE" },
    { label: "Industry Interaction", category: "COMMERCE" },
    { kind: "words", lines: ["Exceptional."] },
    { label: "Basketball", category: "SPORTS" },
    { label: "Psychometric Assessment", category: "NEET" },
    { label: "Dance Performance", category: "DESIGN" },
    { label: "Student Progression Plan", category: "JEE" },
    { label: "Theatre Production", category: "NEET" },
    { kind: "words", lines: ["Excellence."] },
    { label: "Math Lab", category: "JEE" },
    { label: "Art & Craft", category: "DESIGN" },
    { label: "Computer Lab", category: "NEET" },
    { label: "Football Match", category: "JEE" },
    { label: "Music Class", category: "NEET" },
    { kind: "words", lines: ["Remarkable."] },
    { label: "Mentor Session", category: "COMMERCE" },
    { label: "Cooking Class", category: "NEET" },
    { label: "Project Showcase", category: "JEE" },
    { label: "Sports Day", category: "NEET" },
    { kind: "words", lines: ["Leadership."] },
    { label: "Yoga Session", category: "JEE" },
    { label: "Hostel Room", category: "NEET" },
    { label: "Debate Club", category: "COMMERCE" },
    { label: "Dining Experience", category: "NEET" },
    { label: "Swimming Practice", category: "JEE" },
    { kind: "words", lines: ["Outstanding."] },
    { label: "Cultural Fest", category: "NEET" },
    { label: "Independence Day Celebration", category: "JEE" },
    { label: "Ganesh Chaturthi", category: "NEET" },
    { label: "Pastoral Care", category: "COMMERCE" },
    { label: "Teachers' Day", category: "NEET" },
    { label: "Evening Study Hall", category: "JEE" },
    { label: "Morning Assembly", category: "NEET" },
    { label: "Lights Out Routine", category: "JEE" },
    { kind: "words", lines: ["Aspiration."] },
    { label: "Weekend Activities", category: "NEET" },
    { label: "Dorm Parent Time", category: "JEE" },
    { label: "Common Lounge", category: "NEET" },
    { label: "Outdoor Courts", category: "COMMERCE" },
    { label: "Physics Lab", category: "JEE" },
    { label: "Chemistry Lab", category: "NEET" },
    { label: "Biology Lab", category: "NEET" },
    { label: "Board Prep Hall", category: "JEE" },
    { label: "Counselling Room", category: "NEET" },
    { label: "Innovation Studio", category: "JEE" },
    { label: "Maker Space", category: "NEET" },
    { label: "Astronomy Club", category: "NEET" },
    { label: "Robotics Lab", category: "JEE" },
    { label: "Language Lab", category: "NEET" },
    { label: "Study Pods", category: "NEET" },
